...
| [TASK-006](TASK-006-verb-drill-play-button-fix.md) | Verb Drill Play Button Fix (resume + TTS icons) | BUG | 10-verb-drill, 12-training-card-session | 2026-05-14 |
| [TASK-007](TASK-007-verb-drill-exit-navigation.md) | Verb Drill Exit Navigation to HOME | BUG | 10-verb-drill | 2026-05-14 |
