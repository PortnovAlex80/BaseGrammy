...
class SessionEngineResumeRegressionTest {
    ...
    fun `currentCardId always within pool invariant`() = runTest {
        ...
        fun assertInvariant(s: com.alexpo.grammermate.v2.core.domain.model.SessionSnapshot) {
    ...
    fun `resume unknown session returns null`() = runTest {
        ...
        assertThat(engine.resumeSession(com.alexpo.grammermate.v2.core.domain.model.SessionId("ghost"))).isNull()
    }
